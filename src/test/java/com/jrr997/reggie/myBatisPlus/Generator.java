package com.jrr997.reggie.myBatisPlus;
...
public class Generator {
    public static void main(String[] args) {
        ...
        //手动配置数据源
        String url="jdbc:mysql://localhost:3306/reggie";   //注意修改数据库名
        String name="root";
        String password="123456";

        //数据库表的设置
        String[] listTable = {"setmeal_dish"};  //设置需要自动代码生成的表名
        String[] listTableSuffix = {"_b"};  //设置需要自动代码生成的表名
        String[] listTablePrefix = {"t_","c_"};  //设置需要自动代码生成的表名

        //基本信息
        String author = "jrr997";    //作者
        String parent = "com.jrr997";   //父包名
        String module = "reggie";   //模块包名
